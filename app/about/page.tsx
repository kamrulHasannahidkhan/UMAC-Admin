...
// Exact structural + class match of client-site/components/AboutSection.tsx, scaled for preview.
    ...
    <div className="sticky top-6">
      ...
      <div className="w-full bg-white border border-gray-200 rounded-lg overflow-hidden p-4">
        <div className="grid grid-cols-1 gap-6 items-center">
          {/* Image collage — same structural relationship as AboutSection */}
...
export default function AboutAdminPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const url = about ? "/api/about" : "/api/about";
