...
import TestimonialsContent from "@/models/TestimonialsContent";
...
export async function PUT(req: NextRequest) {
  ...
  const body = await req.json();
  const updated = await TestimonialsContent.findByIdAndUpdate(existing._id, body, { new: true });
