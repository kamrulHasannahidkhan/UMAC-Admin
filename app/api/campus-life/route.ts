...
import CampusLife from "@/models/CampusLife";
...
export async function PUT(req: NextRequest) {
  ...
  const body = await req.json();
  const updated = await CampusLife.findByIdAndUpdate(existing._id, body, { new: true });
