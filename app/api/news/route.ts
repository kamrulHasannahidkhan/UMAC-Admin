...
export async function PUT(req: NextRequest) {
  ...
  const body = await req.json();
  const updated = await NewsContent.findByIdAndUpdate(existing._id, body, { new: true });
